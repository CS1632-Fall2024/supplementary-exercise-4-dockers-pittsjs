...
public class D3Test {
  ...
  public void tEST1LINKS() {
    ...
    assertEquals("https://cs1632.appspot.com/reset", vars.get("resetHref").toString());
  }
  ...
  public void tEST3CATALOG() {
    ...
    assertEquals("https://cs1632.appspot.com/images/cat2.jpg", vars.get("secondImageSrc").toString());
  }
  ...
  public void tEST9FEED() {
...

    {
      ...
      wait.until(
          ExpectedConditions.visibilityOfElementLocated(By.xpath("//*[@id='feedResult' and text()='Nom, nom, nom.']")));
    }
  ...
  public void tEST11GREETACATWITHNAME() {
    ...
    js.executeScript("document.cookie = \"1=false\"; document.cookie = \"2=false\"; document.cookie = \"3=false\";");
    assertThat(driver.findElement(By.xpath("//*[text()=\'Meow! from Jennyanydots.\']")).getText(),
        is("Meow! from Jennyanydots."));
  }

  @Test
  public void dEFECT1FEEDZERO() {
    driver.get("https://cs1632.appspot.com/");
    js.executeScript("document.cookie = \"1=false\"; document.cookie = \"2=false\"; document.cookie = \"3=false\";");
  ...
  @Test
  public void dEFECT2GREETQUOTES() {
    driver.get("https://cs1632.appspot.com/greet-a-cat/\"\"");
    js.executeScript("document.cookie = \"1=false\"; document.cookie = \"2=false\"; document.cookie = \"3=false\";");
    {
      List<WebElement> elements = driver.findElements(By.xpath("//*[contains(text(), \'\"\" is not here.\')]"));
      assert (elements.size() > 0);
    }
  }

  @Test
  public void dEFECT3GREETCATWITHNEWLINE() {
    driver.get("https://cs1632.appspot.com/greet-a-cat/\"\"");
    js.executeScript("document.cookie = \"1=false\"; document.cookie = \"2=false\"; document.cookie = \"3=false\";");
    vars.put("https://cs1632.appspot.com/greet-a-cat//n/n/n/n/n/n", js.executeScript("return window.location.href"));
    {
